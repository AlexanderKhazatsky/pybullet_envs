...
big_lid = loader(ASSET_PATH, os.path.join(obj_dir, "bowl", "big_lid.urdf"),
              pos=[.75, 0, -.3],
              scale=0.1) #0.25
...
drawer = loader_randomize_color(ASSET_PATH, os.path.join(obj_dir, "drawer", "drawer.urdf"),
              ...
              scale=0.125)
real_drawer = loader_randomize_color(ASSET_PATH, os.path.join(obj_dir, "drawer", "real_drawer.urdf"),
              pos=drawer_pos + np.array([0, 0, 0.12]),
              scale=0.125)
...
button = loader_randomize_color(ASSET_PATH, os.path.join(obj_dir, "button", "button.urdf"),
              ...
              scale=0.25)
wall_button = loader_randomize_color(ASSET_PATH, os.path.join(obj_dir, "button", "wall_button.urdf"),
              pos=drawer_pos + np.array([0, 0, 0.2]),
              scale=0.25)
